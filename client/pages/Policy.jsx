  ...
  return (
    <Row className="mt-12">
      <Col>
        ...
        <p>
          autocar ("us", "we", or "our") operates the
          https://react-native-car-bot.herokuapp.com/ website and the autocar
        ...
        <p>
          ...
          autocar is created with the help of the{' '}
        ...
        <p>autocar uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are located outside Ukraine and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Ukraine and process it there.
        </p>
        <p>
        ...
        <p>
          autocar will take all steps reasonably necessary to ensure that your
        ...
        <p>
          autocar may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of autocar</li>
          <li>
        ...
        <ul>
          <li>By email: react.native.softserveinc@gmail.com</li>
        </ul>
      </Col>
    </Row>
  );
